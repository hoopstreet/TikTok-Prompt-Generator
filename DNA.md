...
v1.1.2: [STABLE] Switched to Devel CUDA image to fix 'torch.nn.attention' missing on HF Basic GPU.
v1.1.2: [STABLE] Forced torch==2.5.1 installation to fix FlexAttention compatibility on HF.
