...
v1.1.2: [STABLE] Env fixed. Switched to Devel CUDA image to fix 'torch.nn.attention' missing on HF Basic GPU.
v1.1.2: [STABLE] Env fixed. Forced torch==2.5.1 installation to fix FlexAttention compatibility on HF.
v1.1.3: [CURRENT] Global removal of relative imports to fix 'no known parent package' error.
